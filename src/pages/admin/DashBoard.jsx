...
import { getBrands, createBrand, updateBrand, deleteBrand,toggleBrandVisibility } from '../../apiservice/apiBrand';
...
//////////////////////////////////////////////////////////////////////////////
  const orders = [
    { id: 1, customer: 'Vũ Minh Thuan', total: '25,000,000 đ', status: 'Đã giao' },
    { id: 2, customer: 'Ngô Nhật Tân', total: '1,700,000 đ', status: 'Đang xử lý' },
    { id: 3, customer: 'Lê Tố Tâm', total: '1,800,000 đ', status: 'Đã giao' },
    { id: 4, customer: 'Nguyễn Xuân Mai', total: '2,800,000 đ', status: 'Đang xử lý' },
    { id: 5, customer: 'Trần Bảo Ngọc', total: '3,200,000 đ', status: 'Đã giao' },
  ];

  const customers = [
    { id: 1, name: 'Vũ Minh Thuan', email: 'minhthuan2020@gmail.com', phone: '1900.6777' },
    { id: 2, name: 'Ngô Nhật Tân', email: 'nhattan@gmail.com', phone: '1900.6777' },
    { id: 3, name: 'Lê Tố Tâm', email: 'totam@gmail.com', phone: '1900.6777' },
    { id: 4, name: 'Nguyễn Xuân Mai', email: 'xuanmai@gmail.com', phone: '1900.6777' },
    { id: 5, name: 'Trần Bảo Ngọc', email: 'baongoc@gmail.com', phone: '1900.6777' },
  ];
    ...
    <div className="min-h-screen flex font-roboto bg-gray-100">
      ...
      <aside className="w-64 bg-white shadow-lg fixed h-full">
        <div className="p-4 border-t">
          <div className="flex items-center gap-3">
            <img src={TFiveLogo} alt="Admin Avatar" className="h-10 w-10 rounded-full" />
            <div>
            ...
            {tabs.map((tab) => (
              <motion.li
                ...
                className={`px-4 py-3 cursor-pointer flex items-center gap-3 transition-colors duration-200 ${
                  activeTab === tab.value ? 'bg-red-700 text-white' : 'text-gray-700 hover:bg-gray-200'
                }`}
                onClick={() => {
      ...
      <div className="flex-1 ml-64">
        ...
        <header className="bg-red-700 text-white p-4 flex justify-between items-center shadow-md">
          <h1 className="text-xl font-semibold">Admin Dashboard - T-Five Watch</h1>
          <div className="flex items-center gap-3">
            <motion.button
            ...
            >
              🔔
              <span className="absolute -top-1 -right-1 bg-yellow-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">3</span>
            </motion.button>
            <motion.button
        ...
        <main className="p-6">
          <AnimatePresence mode="wait">
            {activeTab === 'overview' && (
              ...
              >
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">Tổng quan</h2>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                  {[
                    { icon: '💰', title: 'Tổng doanh thu', value: '1,900,677,777 đ', change: '↓ 12% so với tháng trước', changeColor: 'text-red-500' },
                    { icon: '👥', title: 'Tổng khách hàng', value: '1,200', change: '↑ 16% so với tháng trước', changeColor: 'text-green-500' },
                    { icon: '📦', title: 'Tổng đơn hàng', value: '320', change: '↑ 8% so với tháng trước', changeColor: 'text-green-500' },
                    { icon: '📈', title: 'Tổng lợi nhuận', value: '650,000,000 đ', change: '↓ 5% so với tháng trước', changeColor: 'text-red-500' },
                  ].map((card, index) => (
                    <motion.div
                      key={card.title}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <Bar
                        ...
                        options={{
                          ...
                          scales: {
                            ...
                            y: { title: { display: true, text: 'Doanh thu (triệu đồng)' }, beginAtZero: true },
                          },
                          animation: {
                            duration: 1000,
                            easing: 'easeOutQuart',
                  ...
                  <motion.div
                    ...
                    animate="visible"
                  >
                    <h3 className="text-lg font-semibold mb-4">Lưu lượng truy cập theo thiết bị</h3>
            ...
            {activeTab === 'products' && (
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">Quản lý sản phẩm</h2>
                ...
                <div className="bg-white rounded-lg shadow-md overflow-x-auto">
                        ...
                        >
                          ...
                          <td className="p-3">{product.soLuong}</td>
                           <td className="p-3">{product.danhMuc}</td>                                   
                            <td className="p-3">{getBrandName(product.thuongHieu)}</td>
                          <td className="p-3">
                            <motion.button
                  ...
                  <div className="flex justify-between items-center p-4">
                    <span>Trang {currentPage} / {totalPages(filteredProducts)}</span>
      ...
      <motion.div
        ...
        transition={{ duration: 0.3 }}
      >
        <h2 className="text-2xl font-semibold mb-6 text-gray-800">Quản lý Thương Hiệu</h2>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-x-auto">
            ...
            <tbody>
              {paginate(filteredBrands).map((brand, index) => (
                ...
                >
                  ...
                  <td className="p-3">{brand.isVisible ? 'Hiển thị' : 'Ẩn'}</td>
                  <td className="p-3">
                    <motion.button
          ...
          <div className="flex justify-between items-center p-4">
            <span>Trang {currentPage} / {totalPages(filteredBrands)}</span>
            <div className="flex gap-2">
              <motion.button
                className="px-3 py-1 bg-gray-200 rounded disabled:opacity-50"
                disabled={currentPage === 1}
            ...
            {activeTab === 'orders' && (
              ...
              >
                ...
                <div className="bg-white rounded-lg shadow-md overflow-x-auto">
                    ...
                    <tbody>
                      {paginate(filteredOrders).map((order, index) => (
                        ...
                        >
                          ...
                          <td className="p-3">
                            <span
                              className={`px-2 py-1 rounded ${order.status === 'Đã giao' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'}`}
                            >
                              {order.status}
                            </span>
                          </td>
                  ...
                  <div className="flex justify-between items-center p-4">
                    <span>Trang {currentPage} / {totalPages(filteredOrders)}</span>
                    <div className="flex gap-2">
                      <motion.button
                        className="px-3 py-1 bg-gray-200 rounded disabled:opacity-50"
                        disabled={currentPage === 1}
            ...
            {activeTab === 'customers' && (
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">Quản lý khách hàng</h2>
                <div className="flex justify-between items-center mb-4">
                  <motion.input
                    type="text"
                ...
                <div className="bg-white rounded-lg shadow-md overflow-x-auto">
                  ...
                  <div className="flex justify-between items-center p-4">
                    <span>Trang {currentPage} / {totalPages(filteredCustomers)}</span>
                    <div className="flex gap-2">
                      <motion.button
                        className="px-3 py-1 bg-gray-200 rounded disabled:opacity-50"
                        disabled={currentPage === 1}
            ...
            {activeTab === 'analytics' && (
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <h2 className="text-2xl font-semibold mb-6 text-gray-800">Thống kê</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <motion.div
                    className="bg-white p-6 rounded-lg shadow-md"
                    variants={chartVariants}
                  ...
                  >
                    ...
                    <div className="h-64 flex items-center justify-center">
                      <div className="w-1/2">
                        <Doughnut
                          data={{
                            labels: ['Đồng hồ Nam 1', 'Đồng hồ Rolex 33', 'Đồng hồ Cặp 1'],
                            datasets: [
                              {
                                data: [40, 35, 25],
                                backgroundColor: ['#A61C28', '#D4AF37', '#E5E7EB'],
